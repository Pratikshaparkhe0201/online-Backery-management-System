      ...
      <div class="row navbar-fixed">
         <nav class="black">
            <div class="nav-wrapper">
               <a href="#" class="brand-logo">Magnifico Dessert</a>
               <a href="#" data-activates="mobile-demo" class="button-collapse"><i class="material-icons">Menu</i></a>
               <ul id="categories1" class="dropdown-content" databeloworigin="true">
                  <li><a href="category1.php" class="dropdown_link">Wedding Cake</a></li>
                  <li><a href="category2.php" class="dropdown_link">Birthday Cake</a></li>
                  <li class="divider"></li>
                  <li><a href="category3.php" class="dropdown_link">Donuts</a></li>
                  <li><a href="category4.php" class="dropdown_link">Biscotti</a></li>
                  <li><a href="category5.php" class="dropdown_link">Cup Ckae</a></li>
                  <li><a href="category6.php" class="dropdown_link">Chocolate</a></li>
                  <li><a href="category7.php" class="dropdown_link">Dairy Milk</a></li>
               ...
               <ul class="side-nav" id="mobile-demo">
                <li><a href="index.php" class="side_logo left-align">Magnifico Dessert</a></li>
                <hr>
